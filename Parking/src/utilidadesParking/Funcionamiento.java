...
public class Funcionamiento {
    ...
    public static Vehiculo vehiculo(Scanner sc, Parking parking) {
        ...
        String nombrePro = LecturaDatos.introDatoVehiculo(sc, "Propietario/a", parking);
        String marca = LecturaDatos.introDatoVehiculo(sc, "Marca", parking);
        String modelo = LecturaDatos.introDatoVehiculo(sc, "Modelo", parking);
        String color = LecturaDatos.introDatoVehiculo(sc, "Color", parking);
